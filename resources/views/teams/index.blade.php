...
@section('content')
    <div x-data="{ open: false }">
        ...
        <x-modal id="team-create-modal" title="Create team">
            <form method="POST" action="{{ route('teams.store') }}" enctype="multipart/form-data" class="grid gap-6 md:grid-cols-2">
                @csrf
                @include('teams._form_fields', ['team' => new \App\Models\Team(), 'seasons' => $seasons])
