<div
    x-data="bhojpuriChatbot({
        title: <?php echo \Illuminate\Support\Js::from($title ?? 'Bhojpuri Sahayak')->toHtml() ?>,
        greeting: <?php echo \Illuminate\Support\Js::from($greeting ?? 'नमस्ते! हमार Bhojpuri सहायक ह। खेल, टीम, मैच, चोट, भा transfer पर पूछीं।')->toHtml() ?>,
    })"
    x-init="init()"
...
>
    ...
    <div x-cloak x-show="open" x-transition class="relative mb-4 w-[calc(100vw-2rem)] max-w-sm overflow-hidden rounded-[1.75rem] border border-slate-200 bg-white shadow-2xl dark:border-slate-800 dark:bg-slate-950 sm:w-[22rem]">
        <div class="flex items-center justify-between border-b border-slate-200 px-4 py-3 dark:border-slate-800">
            <div>
                <p class="text-xs font-semibold uppercase tracking-[0.28em] text-brand-600"><?php echo e($title ?? 'Bhojpuri Sahayak'); ?></p>
...
</div><?php /**PATH C:\Users\lucky\OneDrive\Pictures\Desktop\sportmanagmentsystem\resources\views/components/chatbot.blade.php ENDPATH**/ ?>