...
<?php $component->withAttributes(['title' => 'Teams','subtitle' => 'Register and maintain club profiles, budgets, and contacts.']); ?>
             <?php $__env->slot('actions', null, []); ?> 
                <button class="btn-primary" type="button" @click="open = true">Create team</button>
             <?php $__env->endSlot(); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.modal','data' => ['id' => 'team-create-modal','title' => 'Create team']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'team-create-modal','title' => 'Create team']); ?>
            <form method="POST" action="<?php echo e(route('teams.store')); ?>" enctype="multipart/form-data" class="grid gap-6 md:grid-cols-2">
                <?php echo csrf_field(); ?>
                <?php echo $__env->make('teams._form_fields', ['team' => new \App\Models\Team(), 'seasons' => $seasons], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
