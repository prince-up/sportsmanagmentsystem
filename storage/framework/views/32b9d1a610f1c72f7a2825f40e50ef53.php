...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.modal','data' => ['id' => 'player-create-modal','title' => 'Add player']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'player-create-modal','title' => 'Add player']); ?>
            <form method="POST" action="<?php echo e(route('players.store')); ?>" class="grid gap-6 md:grid-cols-2">
                <?php echo csrf_field(); ?>
                <?php echo $__env->make('players._form_fields', ['player' => new \App\Models\Player(), 'teams' => $teams, 'seasons' => $seasons], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
